...
class ViewTest(TestCase):
    ...
    def setUp(self):
        ...
        self.user.save()
        self.client = Client()
        self.client.login(username="email.test@gmail.com", password="userpassword")
    ...
    def test_post_status_success(self):
        ...
        response = self.client.post('/api/v1/trip/10/checkpoint/20/photo/30/comment/40/like/', json.dumps({
            "user": 2}), content_type="application/json")
        self.assertEqual(response.status_code, 201)

    def test_post_status_400(self):
        """Ensure that POST method returns status 400, when data is not passed."""

        response = self.client.post('/api/v1/trip/10/checkpoint/20/photo/30/comment/400/like/',
    ...
    def test_delete_success(self):
        ...
        response = self.client.delete('/api/v1/trip/10/comment/50/')
