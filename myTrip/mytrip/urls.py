...
urlpatterns = [
    ...
    url(r'^api/v1/like/', include('like.urls_checkpoint')),
    url(r'^api/v1/like/', include('like.urls_comment')),
    url(r'^api/v1/like/', include('like.urls_photo')),
    url(r'^api/v1/like/', include('like.urls_trip')),
